...
* [2023-08-30 Wed] The Lean Startup                                :startups:
:PROPERTIES:
:CUSTOM_ID: lean-startup
:END:

I'm obsessively re-reading Eric Ries' "The Lean Startup". All I remember from the redbull-fuelled haze during university is that you should always build an MVP, then give it to users and see if they use it.

Don't waste time building the whole solution, *build-pivot,build-pivot,build-pivot*.

I'm glad to now read it, after a decade at an innovation company and a few years of engineering management behind me, to see a whole new side to "lean startups".

1. Eric argues *entrepreneurship is a form of "management"*, and uni V would not have agreed with this sentiment one bit (growth 😅). Startups are chaotic and non-hierarchical but they need a process too.
